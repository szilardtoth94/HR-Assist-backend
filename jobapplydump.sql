...
CREATE TABLE `job_apply` (
  ...
  CONSTRAINT `fk_job_persInf` FOREIGN KEY (`user_id`) REFERENCES `personal_info` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `job_apply` VALUES (1,2,1),(22,8,35),(23,2,35);
...
INSERT INTO `job_requirments` VALUES (13,2,NULL,1),(16,2,NULL,5),(18,2,NULL,3),(35,8,NULL,4),(36,8,NULL,6),(37,8,NULL,3);
...
INSERT INTO `personal_info` VALUES (1,'Szili','Toth','dsafgsdgvsadfv  uqfwewpdws ce pefpwewq pwqr fpoiw     hfqioewewfqew',1,NULL),(2,'Szili','T','Lorem ipsum dolor sit amet, consectetuer adip',2,NULL),(31,'asdffdas','sadfdsa',NULL,31,'https://scontent.fomr1-1.fna.fbcdn.net/v/t1.0-9/18519964_1501795996518881_8097497230756775869_n.jpg?oh=7d1bb2213ec90edce812de8c816937d5&oe=5A2AB965'),(33,'Acces','User','adsfdfhsgfd',33,NULL),(35,'Levente','Szarvadi','werhrgf',35,NULL);
...
INSERT INTO `skills` VALUES (1,'HTML','HTML'),(2,'Angular2','Angular2'),(3,'JS','js'),(4,'CSS','CSS'),(5,'Java','Java'),(6,'PHP','Php'),(7,'Nodejs','node js');
...
INSERT INTO `user_skills` VALUES (4,2,1),(5,2,4),(9,1,1),(10,2,2),(11,2,3),(54,1,3),(58,33,4),(59,33,6),(62,2,6),(63,35,4),(67,33,7),(68,35,1),(69,35,2);
...
INSERT INTO `user_work_experience` VALUES (1,1,'Arobs','developer','2017-08-01',NULL),(2,2,'Arobs GPS','senior developer','2017-07-31','2017-08-10'),(4,33,'dasfdsaf','dsafsdafsda','2017-08-21','2017-08-08'),(6,33,'feqweqf','efwqgrht','2017-08-01',NULL);
...
INSERT INTO `users` VALUES (1,'szilard','pass3',1,NULL),(2,'szili','57ba172a6be125cca2f449826f9980ca',2,NULL),(31,'hracces','46f94c8de14fb36680850768ff1b7f2a',2,NULL),(33,'useracces','4753908da2cd1e92923c3ddfaa789d25',1,NULL),(35,'szarvadilevente','57ba172a6be125cca2f449826f9980ca',1,NULL);
...
-- Dump completed on 2017-08-28 19:55:34
